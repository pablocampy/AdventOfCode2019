...
const adjacentWithExtraElfRules()
{
...
const matchAllRules = (number, lowRange, highRange) => isSixDigit(number) && isInRange(number, lowRange, highRange) && adjacentDigitsSame(number) && digitsIncreaseLeftToRight(number);
